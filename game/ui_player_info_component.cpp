...
PlayerInfoComponent::PlayerInfoComponent(int x_, int y_, int vindex_, int w_, int h_, const Player& player_)
: x(x_), y(y_), vindex(vindex_), width(w_), height(h_), player(player_) {}
