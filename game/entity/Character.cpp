...
Character::Character(
        ...
        int agility, int dexterity, int vitality, int currentHealth, int maxHealth, int currentMana, int maxMana, engine::Renderer& renderer, game::world::GameWorld& world)
    : Entity(
            name, renderChar, position, facingDirection, renderer, world
            ), 
    level_(level),
